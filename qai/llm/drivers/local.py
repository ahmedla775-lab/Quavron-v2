...
class LocalDriver(BaseDriver):
    ...
    def _question_concepts(self, question):
        ...
        # e.g. "هو Quavron AI" after question splitting.
    ...
    def _document_match_score(self, question, document):
        """
        Intent-aware document scoring.

        A document must match the actual question part, not merely
        share the generic Quavron keyword.
        """
        ...
        if "intent:identity" in concepts:
            ...
            # Definition questions require an actual definition,
            # not merely a document mentioning Quavron.
            definition_markers = [
                "هي منصه",
                "هي منصة",
                "منصه رقميه",
            ...
            if has_definition:
                ...
                # Generic operational/feature documents should not
                # outrank an actual definition.
                generic_markers = [
                    "ابدأ بإنشاء حساب",
                    "استكشاف لوحة التحكم",
                    "تجربة qai",
        ...
        # -----------------------------------------------------
        # Avoid generic Quavron descriptions when the question
        # asks about a more specific concept.
        # -----------------------------------------------------
    ...
    # =========================================================
    # Select documents per question part
    # =========================================================
    ...
    def ask(self, prompt, context=""):
        ...
        # Fallback to the legacy multi-document composer
        # only when intent-aware selection cannot produce
        # a usable answer.
        if not answer:
