...
import SellerAccessService from "../../../services/marketplace/SellerAccessService";
...
export default function MarketplaceSettings() {
  ...
  const sellerAccess =
    SellerAccessService.canAccessSeller(user);

  const businessIdentity =
    SellerAccessService.hasBusinessIdentity(user);
    ...
    <div className="mx-auto max-w-5xl p-8">
      ...
      <div className="mt-10 space-y-8">
        ...
        <div className="rounded-2xl border border-[var(--q-border)] bg-[var(--q-surface)] p-6">
          ...
          <div className="mt-4 space-y-3 text-[var(--q-muted)]">

            <p>
              Seller Role:
              {" "}
              <span className={sellerAccess ? "text-green-500" : "text-red-500"}>
                {sellerAccess ? "Active" : "Not Activated"}
              </span>
            </p>
            ...
            <p>
              Business Identity:
              {" "}
              <span className={businessIdentity ? "text-green-500" : "text-yellow-500"}>
                {businessIdentity ? "Verified Type" : "Personal Account"}
              </span>
            </p>
